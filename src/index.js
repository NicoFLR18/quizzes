...
console.log('[pregunta #1]: ', feeling);
...
console.log('[pregunta #5]: ', quarter);
...
console.log('[pregunta #7]: ', petList);
...
console.log('[pregunta #9]: ', directionName);
...
console.log('[pregunta #10]: ', drinkType);