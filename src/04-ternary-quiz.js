 ...
 */
let isSunny = true;
activity = isSunny ? "Go to the beach" : "Stay indoors";
console.log('[pregunta 1]: ', activity);
/**
 * Question 2
...
console.log('[pregunta 3]: ', isEvenLength);
/**
 * Question 4
...
isApple = fruits[0] === 'apple' ? true : false;
console.log('[pregunta 7]: ', isApple);
 ...
 */
let height = 180;
let basketball = height > 175 ? "You're tall enough to play" : 'Might be a bit short';
console.log('[pregunta 8]: ', basketball);
/**
 * Question 9
...
console.log('[pregunta 9]: ', workday);
/**
 * Question 10
...
console.log('[pregunta 10]: ', isLengthFive)